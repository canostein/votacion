...
function load_ready_msg(){
    /*
     * Envia la se̱ar "document_ready" al backend.
     */
    send('document_ready');
}

function inicializar_interfaz(){
    /* Manda la se̱al de inicializar la interfaz de votacion. */
    send('inicializar_interfaz');
}

function cargar_cache(){
    /* Mand la se̱al de cargar el cache. */
    send('cargar_cache');
}
...
function prepara_impresion(){
    /*
     * Envia la se̱al para preparar la impresion.
     */
    send('prepara_impresion');
}

function previsualizar_voto(){
    /* Envia la se̱al avisandole al backend que queremos previsualizar el
     * voto.
     */
...
function confirmar_seleccion(){
    /* Envia la se̱al avisandole al backend que queremos confirmar la
     * seleccion.
     */
